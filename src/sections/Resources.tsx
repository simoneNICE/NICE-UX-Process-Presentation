          ...
          {resources.map((r) => {
            ...
            return (
              <a
                ...
                className="flex items-center gap-5 bg-white border border-border rounded-2xl px-6 py-5 hover:border-blue-200 hover:shadow-lg hover:shadow-blue-50 transition-all duration-200 group"
              >
