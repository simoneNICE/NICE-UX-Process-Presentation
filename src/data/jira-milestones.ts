...
const S194 = sprint(10653, "CX.26.4.194 (05Aug26)", "2026-08-05", "2026-08-25")
const S195 = sprint(10654, "CX.26.4.195 (26Aug26)", "2026-08-25", "2026-09-15")

// Ordine: pillar (rank capability JIRA) > progetto (rank epic JIRA) > task (rank JIRA).
// Non riordinare per chiave: il rank e' l'ordine con cui JIRA mostra i task nel backlog.
export const milestones: Milestone[] = [
  // Governance / Operating Model for Design System (CXUX-14034)
  m("CXUX-14035", "Governance", "Operating Model for Design System", "Ops Lead Playbook", "in_progress", "Simone Mimun", "<custom data-type=\"smartlink\" data-id=\"id-0\">https://nice-ce-cxone-prod.atlassian.net/wiki/x/54Gv8</custom> \n\n<custom data-type=\"smartlink\" data-id=\"id-1\">https://nice-ce-cxone-prod.atlassian.net/wiki/x/RQOq8</custom> "),
  m("CXUX-14036", "Governance", "Operating Model for Design System", "Training to DS team", "todo", "Simone Mimun", ""),
  m("CXUX-14037", "Governance", "Operating Model for Design System", "Build and own the ownership on the communication", "todo", "Simone Mimun", ""),
  ...
  // Efficiency / AI Adoption (CXUX-13122)
  m("CXUX-13410", "Efficiency", "AI Adoption", "Project Work Plan", "done", "Lihi Shrem", "", S193),
  m("CXUX-13745", "Efficiency", "AI Adoption", "Creating Survey", "done", "Lihi Shrem", "", S193),
  m("CXUX-13797", "Efficiency", "AI Adoption", "Survey Analysis", "in_progress", "Lihi Shrem", ""),
  m("CXUX-13525", "Efficiency", "AI Adoption", "AI Usage Interviews - Pune + US location Designers - SBG", "todo", "Sheetal Barge-Gole", ""),
  m("CXUX-13407", "Efficiency", "AI Adoption", "AI Usage Interviews - 4 Designers (1)", "todo", "Lihi Shrem", "", S194),
  m("CXUX-13471", "Efficiency", "AI Adoption", "AI Usage Interviews - 4 Designers (2)", "todo", "Lihi Shrem", "", S195),
  m("CXUX-14044", "Efficiency", "AI Adoption", "Survey and Interview Report", "todo", "Lihi Shrem", ""),
  m("CXUX-13805", "Efficiency", "AI Adoption", "Process for AI Usage", "todo", "Simone Mimun", ""),
